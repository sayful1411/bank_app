...
<body class="h-full">
    <div class="min-h-full">
        <div class="pb-32 bg-sky-600">
                        ...
                        <div class="flex items-center px-2 lg:px-0">
                            <div class="hidden sm:block">
                                <div class="flex space-x-4">
                                    <a href="/admin/dashboard" class="px-3 py-2 text-sm font-medium text-white rounded-md bg-sky-700">Dashboard</a> 
            ...
            <header class="py-10">
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <h1 class="text-3xl font-bold tracking-tight text-white"> Hello <?= $_SESSION['admin_name']?> </h1>
                </div>
            </header>
        </div>
        <main class="-mt-32">
            <div class="px-4 pb-12 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="py-8 bg-white rounded-lg">
                    <h3 class="text-center font-bold">Welcome to Admin Dashboard</h3>
                </div>
            </div>
        </main>
    </div>
